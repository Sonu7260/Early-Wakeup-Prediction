...
# 2. Strict ordered list of EXACTLY 63 features expected by your model 
FEATURE_ORDER = [
    ...
    # Added missing columns to satisfy the 63-feature expectation constraint:
    'Stress_Disorder_Risk', 'Anxiety_Risk', 'Depression_Risk', 'Fatigue_Risk', 'Immune_Risk', 'Productivity_Risk'
]
...
<div class="container">
    ...
    <div class="card main-card">
        <div class="hero-banner">
            ...
            <p>Input data values safely. Categorical dropdown values map cleanly into your model pipeline.</p>
        </div>
...
def home():
    ...
    if request.method == "POST":
        ...
        try:
            # Initialize exactly 63 features to 0.0 to prevent shape mismatch exceptions
            form_data = {feature: 0.0 for feature in FEATURE_ORDER}
            
            # Map input elements securely from form submission
